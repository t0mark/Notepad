...
# Cleanup on exit
trap "echo 'Shutting down...'; kill $KAKAO_PID $FASTLIO_PID $FRNET_PID $TF_PID $INS_PID $DWA_PID $RVIZ_PID $ROBOT_DESCRIPTION_PID 2>/dev/null; exit" SIGINT SIGTERM
