...
- **다른 월드 실행**
  ...
  ```bash
  # citysim 월드 실행
  roslaunch gazebo_simulation gazebo_spawn.launch world_name:=citysim
  ```
...
- **`gazebo_spawn_TF.launch`**
  ...
  ```bash
  roslaunch gazebo_simulation gazebo_spawn_TF.launch
  ```
...
- **`gazebo_spawn_TF_2.launch`**
  ...
  ```bash
  roslaunch gazebo_simulation gazebo_spawn_TF_2.launch
  ```
