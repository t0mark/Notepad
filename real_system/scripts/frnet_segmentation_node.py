...
class FRNetSegmentation:
    def __init__(self):
        ...
        # 파라미터 로드
        self.config_path = rospy.get_param('~config', '/home/api/api_navigation_ws/src/real_system/configs/frnet/frnet-semantickitti_seg.py')
        self.checkpoint_path = rospy.get_param('~checkpoint', '/home/api/api_navigation_ws/src/real_system/checkpoints/frnet_semantickitti.pth')
