...
class MLDASSegDataset(Seg3DDataset):
    METAINFO = {
        'classes': ('unlabeled', 'road', 'sidewalk', 'car', 'other-vehicle'),
        'palette': [[255, 255, 255], [255, 120, 50], [255, 192, 203], [255, 255, 0], [0, 150, 245]],
        'seg_valid_class_ids':
        tuple(range(5)),
        'seg_all_class_ids':
        tuple(range(5)),
    ...
    def __init__(self,
                 ...
                 **kwargs) -> None:
        super(MLDASSegDataset, self).__init__(
            data_root=data_root,
            ann_file=ann_file,
            metainfo=metainfo,
